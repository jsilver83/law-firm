...
urlpatterns = [
    url(r'^invoices/$', views.InvoiceListing.as_view(), name='invoice_listing'),
    ...
    url(r'^fund_requests/$', views.FundRequestListing.as_view(), name='fund_request_listing'),
    ...
    url(r'', views.TransactionListing.as_view(), name='transaction_listing'),
]
